...
const fetchSummary = async()=>{
  try{
const summary =await axios.get('https://employee-management-system-q86i.onrender.com/api/dashboard/summary',{
  headers: {
    ...
    <div className='p-6'>
      ...
      <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mt-6'>
        <SummaryCard icon={<FaUsers/>} text="Total Employees" number={summary.totalEmployees} color="bg-teal-600"/>
         <SummaryCard icon={<FaBuilding/>} text="Total Dapartment" number={summary.totalDepartments} color="bg-yellow-600"/>
          <SummaryCard icon={<FaMoneyBillWave/>} text="Monthly Salary" number={summary.totalSalary} color="bg-yred-600"/>
      </div>
