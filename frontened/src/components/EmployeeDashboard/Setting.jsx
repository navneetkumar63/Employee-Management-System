...
<form onSubmit={handleSubmit}>
    <div>
        <label className='text-sm font-medium texxt-gray-700'>
            Old Password </label>
            <input type='password' name='oldPassword' placeholder='changePassword' onChange={handleChange} className='mt-1 w-full p-2 border border-gray-300 rounded-md' required/>
    </div>
    ...
    <button type='sumbit' className='w-full mt-6 bg-teal-600 hover:bg-teal-700 text-white font-bold py-2 px-4 rounded'>
        Change Password
    </button>
